...
connection.onInitialized(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    comment.setSetting(yield connection.workspace.getConfiguration('vscodeGoogleTranslate'));
}));
...
const shortLive = new short_live_1.ShortLive((item, data) => {
...
connection.onHover((textDocumentPosition) => __awaiter(void 0, void 0, void 0, function* () {
    if (!comment)
        return null;
    const hover = yield comment.getComment(textDocumentPosition);
